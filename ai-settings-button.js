...
(() => {
  ...
  function attachQuestionnairePanel(){
    ...
    style.textContent=`
      ...
      #freeConsultationDialog .fcq-body{display:grid;grid-template-columns:minmax(0,1fr) 370px;gap:14px;min-height:0;flex:1}
      #freeConsultationDialog .fcq-main{min-width:0;min-height:0;overflow:auto;padding-right:4px}
      ...
      #freeConsultationDialog .fcq-panel-title{font-size:14px;font-weight:900;color:#263d58;line-height:1.25}
      #freeConsultationDialog .fcq-panel-meta{font-size:10px;color:#71839a;margin-top:3px;line-height:1.35}
      #freeConsultationDialog .fcq-panel-spacer{flex:1}
      #freeConsultationDialog .fcq-hide{height:30px!important;padding:0 9px!important;font-size:11px!important;white-space:nowrap}
      #freeConsultationDialog .fcq-selector-wrap{padding:10px 12px;border-bottom:1px solid #edf1f5;background:#fff}
      #freeConsultationDialog .fcq-selector-label{display:block;font-size:10px;font-weight:900;color:#61758c;margin-bottom:5px}
      #freeConsultationDialog .fcq-selector{width:100%;box-sizing:border-box;border:1px solid #cbd7e3;border-radius:8px;background:#fff;padding:7px 8px;font:600 11px 'Segoe UI',Arial,sans-serif;color:#31465f}
      ...
      #freeConsultationDialog .fcq-question{font-size:10px;font-weight:900;line-height:1.35;color:#52677f;margin-bottom:5px}
      #freeConsultationDialog .fcq-value{font-size:12px;line-height:1.5;color:#26384d;white-space:pre-wrap;overflow-wrap:anywhere}
      #freeConsultationDialog .fcq-empty{padding:18px 8px;text-align:center;color:#7a8b9f;font-size:11px;line-height:1.45}
      #freeConsultationDialog .fcq-show{display:none;height:34px!important;padding:0 10px!important;margin-left:auto;white-space:nowrap;font-size:11px!important}
      ...
      @media(max-width:1050px){
        ...
        #freeConsultationDialog .fcq-panel{position:absolute;top:70px;right:18px;bottom:18px;width:min(390px,calc(100vw - 36px));z-index:4;box-shadow:0 18px 55px rgba(15,23,42,.22)}
      ...
      @media(max-width:720px){#freeConsultationDialog .fcq-panel{top:62px;right:10px;bottom:10px;width:calc(100vw - 40px)}}
    `;
