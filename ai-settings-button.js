...
(() => {
  ...
  function loadQuestionnaireIntegrations(){
    ...
    const storage=loadOnce('integration-folder-storage.js?v=20260913-140','data-integration-folder-storage','__diagnostikaIntegrationStorageReady');
    const loadCore=()=>{
      const core=loadOnce('form-integrations.js?v=20260913-140','data-form-integrations','__diagnostikaFormIntegrationsReady');
      const loadHelpers=()=>{
        loadOnce('form-integrations-copy-fix.js?v=20260913-140','data-form-integrations-copy-fix','__formIntegrationsCopyFixReady');
        loadOnce('form-integrations-inbox-fix.js?v=20260913-140','data-form-integrations-inbox-fix','__formIntegrationsInboxFixReady');
        loadOnce('form-integrations-lock.js?v=20260913-140','data-form-integrations-lock','__formIntegrationsLockReady');
        loadOnce('client-questionnaires.js?v=20260913-140','data-client-questionnaires','__diagnostikaClientQuestionnairesReady');
      };
  ...
  loadOnce('ai-processing-indicator.js?v=20260913-140','data-ai-processing-indicator','__diagnostikaAiProcessingIndicatorReady');
  loadOnce('free-consultation-archive.js?v=20260913-140','data-fc-archive','__freeConsultationArchiveReady');
  loadOnce('free-consultation-extra-fields.js?v=20260913-140','data-fc-extra-fields','__freeConsultationExtraFieldsReady');
  attach();
