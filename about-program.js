  ...
  dlg.innerHTML=`
    <div class="about-program-window">
      ...
      <section class="about-program-section">
        <h3>Как появилась программа</h3>
        <p>Изначально система существовала как обычная диагностическая таблица в Excel. Она использовалась для последовательной работы с запросом клиента: ситуации, убеждения, вторичные чувства, глубокие убеждения, инстинктивные реакции и желаемый результат.</p>
        <p>Со временем <strong>Прудников Е.С.</strong> развил эту таблицу: добавил карточки клиентов, отдельные запросы, сессии, историю работы, оплату, подсказки, хранение данных и другие рабочие инструменты. Постепенно таблица превратилась в самостоятельную удобную программу для практической работы специалиста.</p>
      </section>
