...
(() => {
  ...
  function ensurePaymentsFoundation(next){
    const loadModule=()=>{
      ...
      const moduleScript=document.createElement('script');
      moduleScript.src='modules/payments/index.js?v=20260918-payment5b';
    ...
    const serviceScript=document.createElement('script');
    serviceScript.src='modules/payments/payment-service.js?v=20260918-payment5b';
  ...
  function loadPaymentApi(){
    ensurePaymentsFoundation(()=>{
      ...
      api.src='payment-api.js?v=20260918-payment5b';
