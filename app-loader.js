...
(() => {
  ...
  loadOnce('session-payment-data-repair.js?v=20260918-payment5c','data-session-payment-data-repair');
...
(() => {
  ...
  function ensurePaymentsFoundation(next){
    const loadModule=()=>{
      ...
      const moduleScript=document.createElement('script');
      moduleScript.src='modules/payments/index.js?v=20260918-payment5c';
    ...
    const serviceScript=document.createElement('script');
    serviceScript.src='modules/payments/payment-service.js?v=20260918-payment5c';
  ...
  function loadPaymentApi(){
    ensurePaymentsFoundation(()=>{
      ...
      api.src='payment-api.js?v=20260918-payment5c';
