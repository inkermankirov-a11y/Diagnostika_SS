...
(() => {
  ...
  // Основной запрос должен быть выше списка запросов клиента.
  ...
  function getCurrentRequest(){
    // The diagnosis editor may be viewing an archived/non-current request.
    if (typeof mode !== 'undefined' && mode === 'diagnosis' && typeof request === 'function') return request();
